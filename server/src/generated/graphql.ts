...
export type ActionYieldsNoResult = {
...
export type ActionYieldsNoResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActionYieldsNoResult'] = ResolversParentTypes['ActionYieldsNoResult']> = {
